...
Процедура СоздатьКонтрагента(Отказ)
	...
	РеквизитыКонтрагента.Вставить("КонтактноеЛицо", КонтактноеЛицо);
	РеквизитыКонтрагента.Вставить("Телефон", Телефон);
	РеквизитыКонтрагента.Вставить("ЭлектроннаяПочта", ЭлектроннаяПочта);
