...
Процедура ПроверкаИЗагрузкаДокументов(Отказ)
	...
	Для каждого СтрокаЗагрузки Из ЗагружаемыеДокументы Цикл
		...
		Если Не ЗначениеЗаполнено(СтрокаЗагрузки.Контрагент) Тогда
			...
			РеквизитыКонтрагента.Вставить("КонтактноеЛицо", СтрокаСписка.КонтактноеЛицо);
			РеквизитыКонтрагента.Вставить("Телефон", СтрокаСписка.Телефон);
			РеквизитыКонтрагента.Вставить("ЭлектроннаяПочта", СтрокаСписка.ЭлектроннаяПочта);
