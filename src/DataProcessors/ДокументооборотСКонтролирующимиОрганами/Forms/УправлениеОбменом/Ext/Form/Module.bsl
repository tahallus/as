...
Процедура УправлениеЗакладкойУведомлений(Вид = Неопределено)
	...
	ИначеЕсли Вид = "РеестрыАкцизы" Тогда
		...
		// РегламентированныйОтчетРеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт, нажатость подменю
	...
	Если Вид = "РеестрыАкцизы" Тогда
		ТекстЗапроса = ТекстЗапроса + ТекстЗапросаДляОтчетовНаЗакладкеИсходящиеУведомления("РеестрАкцизыПриложение",
			"РеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт");
		Уведомления.ОсновнаяТаблица = "Документ.РегламентированныйОтчет";
	КонецЕсли;
...
Функция ТекстЗапросаДляОтчетовНаЗакладкеИсходящиеУведомления(ИсточникОтчета, ИсточникОтчета2 = "")
	 ...
	 ТекстЗапроса = "ВЫБРАТЬ
	                ...
	                |	И " + ?(ЗначениеЗаполнено(ИсточникОтчета2), "(", "")
	                	+ "РегламентированныйОтчет.ИсточникОтчета ПОДОБНО ""%_ИсточникОтчета_%"""
	                	+ ?(ЗначениеЗаполнено(ИсточникОтчета2), "
	                |	ИЛИ РегламентированныйОтчет.ИсточникОтчета ПОДОБНО ""%_ИсточникОтчета2_%""", "")
	                	+ ?(ЗначениеЗаполнено(ИсточникОтчета2), ")", "");
	
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "_ИсточникОтчета_", ИсточникОтчета);
	Если ЗначениеЗаполнено(ИсточникОтчета2) Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "_ИсточникОтчета2_", ИсточникОтчета2);
	КонецЕсли;
