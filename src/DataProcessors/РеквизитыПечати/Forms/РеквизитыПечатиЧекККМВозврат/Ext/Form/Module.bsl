...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, ПодписьРуководителя, ПодписьЗаведующегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира, Контрагент, КонтактноеЛицоПодписант");
