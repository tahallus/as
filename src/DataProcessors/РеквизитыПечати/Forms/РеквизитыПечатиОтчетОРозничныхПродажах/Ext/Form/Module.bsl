...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, Подразделение, СтруктурнаяЕдиница, ПодписьРуководителя, ПодписьЗаведующегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира");
