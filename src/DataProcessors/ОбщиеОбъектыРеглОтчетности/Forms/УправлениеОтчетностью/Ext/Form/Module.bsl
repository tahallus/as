...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Налог на игорный бизнес" Тогда
		Если ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2021Кв4" Тогда
			ПоказатьПредупреждение(, НСтр(
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Декларация по налогу на имущество" Тогда
		Если ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2022Кв1" Тогда
			ПоказатьПредупреждение(, НСтр(
			...
			|реализована в будущих версиях программы'"));
			Возврат;
		ИначеЕсли ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2021Кв4" Тогда
			ПоказатьПредупреждение(, НСтр(
			"ru='Печать со штрихкодом PDF417 формы
			|отчета в редакции приказа ФНС России
