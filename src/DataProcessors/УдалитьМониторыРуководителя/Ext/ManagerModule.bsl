...
// Функция возвращает используемые для мониторов цвета по строковому представлению.
//
// Параметры:
//  ИмяЦвета - Строка - Название цвета
//
// Возвращаемое значение:
//  Цвет - Используемый в мониторе цвет
//
...
//
// Параметры:
//  ЭлементыСтроки - Массив - Массив структур с ключом "Строка" и значением выводимой строки,
//    остальные ключи соответствуют параметрам конструктора форматированной строки
//
// Возвращаемое значение:
//  ФорматированнаяСтрока - Скомпонованная форматированная строка
//
...
// Добавляет элемент форматированной строки в массив для дальнейшей компоновки
//
// Параметры:
//  ЭлементыСтроки	 - 	Массив	 - Массив элементов форматированной строки
//  Текст			 - 	Строка	 - Текст элемента форматированной строки
//  Шрифт			 - 	Шрифт	 - Шрифт элемента форматированной строки
//  Цвет			 - 	Цвет	 - Цвет элемента форматированной строки
//
Процедура ДобавитьЭлементФорматированнойСтроки(ЭлементыСтроки, Текст, Шрифт = Неопределено, Цвет = Неопределено) Экспорт
...
Функция СформироватьЗаголовок(Знач ИсходнаяСумма) Экспорт
	...
	Иначе	
		СтрокаРазрядТысячи = "";
		СтрокаРазрядЕдиницы = ФорматированнаяСумма;
	КонецЕсли; 
	
	ЭлементыСтроки = Новый Массив;
	ЭлементыСтроки.Добавить(Новый Структура("Строка, Шрифт", 
		СтрокаРазрядТысячи, 
		Новый Шрифт(ШрифтыСтиля.ОченьКрупныйШрифтТекста)));
	ЭлементыСтроки.Добавить(Новый Структура("Строка, Шрифт", 
		СтрокаРазрядЕдиницы, 
