...
Процедура ОбновитьДиаграммуИВиджетДебиторыПоСрокам()
	...
	Если ВыборкаОбщийИтог.Следующий() Тогда
		...
		Элементы.ДекорацияДебиторыМенее7Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгМенее7);
		Элементы.ДекорацияДебиторыМенее30Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгМенее30);
		Элементы.ДекорацияДебиторыБолее31Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгБолее31);
...
Процедура ОбновитьВиджетДебиторы()
	...
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		...
		Элементы.ДекорацияДебиторыАвансИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.СуммаАванса);
	Иначе
