...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияУНФКлиентСервер.ЗаполнитьСписокИзСписка(ДоступныеТипыДиаграммы("НесколькоСерий"), Элементы.ПродажиТипДиаграммы.СписокВыбора);
	ОбщегоНазначенияУНФКлиентСервер.ЗаполнитьСписокИзСписка(ДоступныеТипыДиаграммы("ОднаСерия"), Элементы.ДеньгиТипДиаграммы.СписокВыбора);
	ОбщегоНазначенияУНФКлиентСервер.ЗаполнитьСписокИзСписка(ДоступныеТипыДиаграммы("ОднаСерия"), Элементы.ДолгиТипДиаграммы.СписокВыбора);
	...
	Для Каждого ЭлементСписка Из СоставВиджетов Цикл
		НастройкаВиджета = Обработки.УдалитьМониторыРуководителя.НастройкаВиджетаТекущая(ЭлементСписка.Значение);
...
Процедура ЗаполнитьВиджетыПоУмолчанию()
	...
	СоставВиджетов = Обработки.УдалитьМониторыРуководителя.СоставВиджетовПоУмолчанию();
	
	Для Каждого ЭлементСписка Из СоставВиджетов Цикл
		НастройкаВиджета = Обработки.УдалитьМониторыРуководителя.НастройкаВиджетаПоУмолчанию(ЭлементСписка.Значение);
