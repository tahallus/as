...
Процедура ОбновитьДиаграммуИВиджетКредиторыПоСрокам()
	...
	Если ВыборкаОбщийИтог.Следующий() Тогда
		...
		Элементы.ДекорацияКредиторыМенее7Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгМенее7);
		Элементы.ДекорацияКредиторыМенее30Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгМенее30);
		Элементы.ДекорацияКредиторыБолее31Итог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщийИтог.ДолгБолее31);
		
		Серия = ДиаграммаКредиторыПоСрокам.Серии.Добавить(ДолгМенее7);
		Серия.Цвет = Обработки.УдалитьМониторыРуководителя.ЦветДляМониторов("Зеленый");
		...
		Серия.Цвет = Обработки.УдалитьМониторыРуководителя.ЦветДляМониторов("Желтый");
		...
		Серия.Цвет = Обработки.УдалитьМониторыРуководителя.ЦветДляМониторов("Красный");
...
Процедура ОбновитьВиджетКредиторы()
	...
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		...
		Элементы.ДекорацияКредиторыАвансИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.СуммаАванса);
	Иначе
