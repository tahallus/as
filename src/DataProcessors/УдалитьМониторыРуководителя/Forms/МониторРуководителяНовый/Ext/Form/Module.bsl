...
Процедура ПредставлениеПериодаПродажиНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.УдалитьМониторыРуководителя.Форма.НастройкаМонитора" , ПараметрыФормы, , , , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Настроить(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьНастройкиЗавершение", ЭтотОбъект);
	ОткрытьФорму("Обработка.УдалитьМониторыРуководителя.Форма.НастройкаМонитора" , , , , , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Функция ЗапуститьФоновоеЗаданиеНаСервере()
	...
	ПараметрыПроцедуры.Вставить("НастройкиВиджетов", Обработки.УдалитьМониторыРуководителя.ТекущиеНастройкиВиджетов());
	
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.ЗапуститьВФоне = Истина;
		
	РезультатФоновогоЗадания = ДлительныеОперации.ВыполнитьВФоне(
		"Обработки.УдалитьМониторыРуководителя.ПолучитьДанныеМонитора",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Процедура ОбновитьОтображениеВиджетов()
	...
	СоставВиджетов = Обработки.УдалитьМониторыРуководителя.СоставВиджетовТекущий();
	НастройкиВиджетов = Обработки.УдалитьМониторыРуководителя.ТекущиеНастройкиВиджетов();
...
Функция СформироватьКомпоновщикОтчетаСервер(СвойстваОтчета, Виджет, ОтборОрганизация, ТекущаяДатаСеанса)
	...
	НастройкаВиджета = Обработки.УдалитьМониторыРуководителя.НастройкаВиджетаТекущая(Виджет);
	...
	КомпоновщикНастроек = ОтчетыУНФ.ПолучитьПереопределенныйКомпоновщикНастроек(СвойстваОтчета, ПараметрыИОтборы);
