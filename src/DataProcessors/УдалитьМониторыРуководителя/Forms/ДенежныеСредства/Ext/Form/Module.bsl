...
Процедура ОбновитьВиджетОстаткиДС()
	...
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		Элементы.ДекорацияРасчетныеСчетаИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.СуммаОстаток);
	Иначе
	...
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		Элементы.ДекорацияКассыИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.СуммаОстаток);
	Иначе
...
Процедура ОбновитьВиджетДоходы()
	...
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		Элементы.СуммаДоходовИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.Сумма);
	Иначе
...
Процедура ОбновитьВиджетРасходы()
	...
	ВыборкаОбщиеИтоги = Запрос.Выполнить().Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	Если ВыборкаОбщиеИтоги.Следующий() Тогда
		Элементы.СуммаРасходовИтог.Заголовок = Обработки.УдалитьМониторыРуководителя.СформироватьЗаголовок(ВыборкаОбщиеИтоги.Сумма);
	Иначе
