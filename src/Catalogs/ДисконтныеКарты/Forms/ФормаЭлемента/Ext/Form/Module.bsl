...
Процедура ЗаполнитьИнфомрациюПоДисконтнойКарте()
	...
	ПроцентСкидкиПоДисконтнойКарте = ДисконтныеКартыУНФСервер.ВычислитьПроцентСкидкиПоДисконтнойКарте(ТекущаяДата(), Объект, ДополнительныеПараметры);
	...
	Если ЗначениеЗаполнено(ДополнительныеПараметры.ПредставлениеПериода) Тогда
		Элементы.СуммаПродажПоДисконтнойКарте.Заголовок = НСтр("ru = 'Сумма продаж ('")+ДополнительныеПараметры.ПредставлениеПериода+")";
	Иначе
