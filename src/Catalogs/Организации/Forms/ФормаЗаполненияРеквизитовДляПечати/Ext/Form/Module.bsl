...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеКонтактнойИнформацией.ПриСозданииНаСервере(ЭтаФорма, Объект, Новый Структура("ИмяЭлементаДляРазмещения",
...
Процедура Подключаемый_ЮрАдресНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	УправлениеКонтактнойИнформациейКлиент.НачалоВыбора(ЭтаФорма, Элементы[ПредставлениеЮрАдреса], ,
		СтандартнаяОбработка);
...
Процедура ДобавитьПоляЮрАдрес()
	...
	КИДопРеквизиты.Сортировать("ДействуетС Убыв");
	...
	Элемент = Элементы.Добавить(ДанныеЗаполнения.ИмяРеквизита + "_СоответствиеКИ", Тип("ПолеФормы"),
		Элементы.ГруппаЮрАдрес);
