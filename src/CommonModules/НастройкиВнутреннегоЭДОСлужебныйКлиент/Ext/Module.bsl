...
Процедура ОткрытьСписокПодписантов(Подписанты, Оповещение)
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Подписанты", Подписанты);
	ОткрытьФорму("Обработка.НастройкиВнутреннегоЭДО.Форма.СписокПодписантов", ПараметрыФормы,,,,, Оповещение,
