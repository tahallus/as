...
// декларации по НДС. Предназначена для редакций декларации по НДС, соответствующих формам "ФормаОтчета2021Кв3",
// "ФормаОтчета2020Кв4", "ФормаОтчета2019Кв1" и "ФормаОтчета2017Кв1" отчета "РегламентированныйОтчетНДС".
// Параметры:
...
Процедура ПроверитьЗаполнение_Раздел2(КонтекстВыполнения)
	...
	Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2021Кв3")
