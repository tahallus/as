...
// Возвращает пустой ключ настроек внутреннего ЭДО.
// 
// Возвращаемое значение:
//  Структура:
//  * Организация - ОпределяемыйТип.Организация
//  * ВидВнутреннегоДокумента - СправочникСсылка.ВидыДокументовЭДО
//
Функция НовыйКлючНастройкиВнутреннегоЭДО()
	КлючНастройки = Новый Структура;
	КлючНастройки.Вставить("Организация", Метаданные.ОпределяемыеТипы.Организация.Тип.ПривестиЗначение());
	КлючНастройки.Вставить("ВидВнутреннегоДокумента", Справочники.ВидыДокументовЭДО.ПустаяСсылка());
