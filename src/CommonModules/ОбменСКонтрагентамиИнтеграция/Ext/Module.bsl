...
// * Дата 
// * Сумма 
Функция СформироватьДанныеДляВыгрузки(ОписанияОбъектовУчета, ПараметрыВизуализацииОбъектовУчета = Неопределено) Экспорт
...
Функция НовоеОписаниеОбъектаУчета() Экспорт
	Возврат ИнтеграцияЭДО.НовоеОписаниеОбъектаУчета();
КонецФункции
...
Функция СостоянияАктуальныхДокументооборотов(ОбъектыУчета) Экспорт
	...
	ТекстыЗапросов.Добавить(ЭлектронныеДокументыЭДО.ЗапросСостоянийДокументов(
		"СостоянияДокументооборотов", "ВЫБРАТЬ ЭлектронныйДокумент ИЗ АктуальныеДокументыЭДО"));
	ТекстыЗапросов.Добавить(
		...
		|ИЗ
		|	АктуальныеДокументыЭДО КАК АктуальныеДокументыЭДО
		|	ВНУТРЕНЕЕ СОЕДИНЕНИЕ СостоянияДокументооборотов КАК СостоянияДокументооборотов
		|	ПО АктуальныеДокументыЭДО.ЭлектронныйДокумент = СостоянияДокументооборотов.ЭлектронныйДокумент");
