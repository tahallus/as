...
Процедура ПриФормированииЭлектронногоДокумента(ЭлектронныйДокумент, ВидДокумента, СостояниеЭДО, НаборОбъектовУчета, КонтекстДиагностики) Экспорт
	ИнтеграцияЭДО.ПриФормированииЭлектронногоДокумента(ЭлектронныйДокумент, ВидДокумента, СостояниеЭДО, НаборОбъектовУчета);
КонецПроцедуры
