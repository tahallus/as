...
Процедура ЗаполнитьНаборыСвойствОбъекта(Знач Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	Если ТипСсылки = Тип("СправочникСсылка.Номенклатура") Тогда
		...
		УправлениеСвойствамиУНФ.ЗаполнитьНаборСвойствНоменклатурыПоКатегории(Объект, ТипСсылки, НаборыСвойств);
		
	ИначеЕсли ТипСсылки = Тип("СправочникСсылка.ХарактеристикиНоменклатуры") Тогда
		
		УправлениеСвойствамиУНФ.ЗаполнитьНаборСвойствХарактеристикиПоКатегории(Объект, ТипСсылки, НаборыСвойств);
		
	ИначеЕсли ТипСсылки = Тип("СправочникСсылка.Спецификации") Тогда
		
		УправлениеСвойствамиУНФ.ЗаполнитьНаборСвойствСпецификацииПоКатегории(Объект, ТипСсылки, НаборыСвойств);
		
	ИначеЕсли ТипСсылки = Тип("СправочникСсылка.КомплектацииНоменклатуры") Тогда
		
		УправлениеСвойствамиУНФ.ЗаполнитьНаборСвойствКомплектацииПоКатегории(Объект, ТипСсылки, НаборыСвойств);
