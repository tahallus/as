...
Процедура ЦеныИВалютаНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("СтруктурнаяЕдиница",   Неопределено);
		...
		Для Каждого СтрокаТаблицы Из ОтмеченныеСтроки Цикл
			...
			Для Индекс = 0 По Периоды.Количество()-1 Цикл
				...
				Если ПриводитьКМинимальнымЦенам 
					...
					МинимальнаяСумма = СтрокаТаблицы.МинимальнаяЦена * СтрокаТаблицы["КолонкаКоличество_" + Индекс];
			...
			Для Индекс = 0 По Периоды.Количество()-1 Цикл
				...
				Если ПриводитьКМинимальнымЦенам 
					...
					Если СуммаПоКолонке < МинимальнаяСумма 
						ИЛИ СтрокаТаблицы["КолонкаКоличество_" + Индекс] = 0 Тогда
...
Функция ПолучитьСтруктуруПересчетаЦены(Объект, СтрокаТЧ)
	...
	ЦенообразованиеКлиентСервер.ДополнитьСтруктуруДанныхНоменклатурыСтруктурнойЕдиницей(Объект, Неопределено, Результат);
