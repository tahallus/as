...
Функция РазмерАннуитетногоПлатежа() Экспорт
	...
	// - в первом приближении считаем, что размер платежа равен аннуитетному платежу
	// при единовременной выдаче всех траншей
	// - получаем остаток долга после выполнения всех платежей с таким размером
	// - во втором приближении считаем, что размер платежа на 20% меньше, чем аннуитетный платеж
