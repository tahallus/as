...
Процедура ПодобратьДокумент(Команда)
	...
	НастройкиПодбора = НастройкиПодбораУчетногоДокумента(СпособОбработки, Документооборот);
...
&НаСервереБезКонтекста
Функция НастройкиПодбораУчетногоДокумента(Знач СпособОбработки, Знач Документооборот)
	...
	Настройки.Вставить("Организация", Документооборот.Организация);
	Настройки.Вставить("Контрагент" , Документооборот.Контрагент);
...
Процедура ПерепривязатьЭлектронныйДокумент(ВыбранноеЗначение, СпособОбработки)
	...
	ИнтеграцияЭДО.УстановитьСвязьЭлектронногоДокументаСОбъектомУчета(Документооборот, ВидДокумента, ВыбранноеЗначение);
